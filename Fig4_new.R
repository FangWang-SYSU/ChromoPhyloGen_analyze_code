...
scTrace_dir = '/Volumes/WX_extend/细胞轨迹推断/data/公开数据/wangying/BC_res/patient_cnv_infer2/'
...
saveRDS(BC_list, '/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/data/BC_sctc_all2.rds')
BC_list = readRDS('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/data/BC_sctc_all2.rds')
...
saveRDS(srt, '/Volumes/WX_extend/细胞轨迹推断/data/公开数据/wangying/BC_res/tumor_with_score2.rds')
saveRDS(BC_list_with_score, '/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/data/BC_score_sctc_all2.rds')

srt = readRDS('/Volumes/WX_extend/细胞轨迹推断/data/公开数据/wangying/BC_res/tumor_with_score2.rds')
BC_list_with_score = readRDS('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/data/BC_score_sctc_all2.rds')
...
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/整体UMAP.pdf'),
       a, width=380, height = 380, units='mm', dpi = 600)

ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/整体UMAP_patient.pdf'),
       p1, width=180, height = 120, units='mm', dpi = 600)
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/整体UMAP_PDE.pdf'),
...
p10
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/整体UMAP_Sub.pdf'),
...
a=srt@meta.data %>%
  ...
  scale_fill_gradientn(colours = c('#4DBBD5FF', '#E64B35FF'), limits=c(0,0.2), na.value = '#E64B35FF')+
  labs(y='cell%')+
  theme_classic()+
...
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/PDE高低分组病人比例分布2.pdf'),
...
pp
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/PDE高低分组病人比例分布.pdf'),
...
a = srt@meta.data %>%
  ...
  scale_fill_manual(values=c('High'='#E64B35FF', 'Low'='#4DBBD5FF'))
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/PDE高低分组评分比较_clone(PDE).pdf'),
...
b=srt@meta.data %>%
  ...
  theme(legend.position = 'none',
        axis.title.x = element_blank())
a+b
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/PDE高低分组评分比较_clone.pdf'),
...
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/PDE高低分组比较亚型.pdf'),
...
a = plot_cell_trajectory(FC_cds, color_by = "pde", cell_size = 1)+theme(legend.position = 'right') +
  scale_color_gradientn(colours = c('#4DBBD5FF', '#E64B35FF'), limits=c(0,0.2))
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/monocle_CEE.pdf'),
...
f = f + theme_classic()+
  theme(strip.background = element_blank(),
        ...
        legend.key.size = unit(2, 'mm'),
        legend.title = element_text(size=6))
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/monocle_state.pdf'),
...
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/monocle_Sub.pdf'),
...
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/monocle_patient.pdf'),
       g, width=180, height = 80, units='mm', dpi = 600)

# 排序细胞，root=4
FC_cds = orderCells(FC_cds, root_state = 4)
...
bh5 = cds_meta[cds_meta$State!='1', ]
bh1 = cds_meta[cds_meta$State!='5', ]
...
a = cds_branch %>%
  ...
  theme(strip.background = element_blank(),
        ...
        legend.title = element_text(size=6))
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/分支曲线.pdf'),
...
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/State_pie.pdf'),
...
a = pie_prop %>%
  ...
  theme(strip.background = element_blank(),
        ...
        legend.title = element_text(size=6))
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/State_High_prop.pdf'),
...
a = tmp_data %>%
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.title.y = element_blank())
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/分支boxplot.pdf'),
...
a = tmp_data %>%
  ...
  theme(strip.background = element_blank(),
        ...
        legend.title = element_text(size=6))
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/分支boxplot_cc.pdf'),
...
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/State1v5组比较亚型.pdf'),
       a, width=60, height = 60, units='mm', dpi = 600)
...
a=cds_exprs %>%
  ...
  theme(strip.background = element_blank(),
        ...
        legend.title = element_text(size=6))
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/State1v5组比较PTEN.pdf'),
       a, width=50, height = 50, units='mm', dpi = 600)
...
a = tmp_srt_meta %>%
  ...
  theme(strip.background = element_blank())
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/1v5_chr_num(01).pdf'),
...
a = box_d %>%
  ...
  theme_classic()
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/Seismic_cyto_cor.pdf'),
...
a=all_cell_events %>%
  ...
  theme(panel.grid = element_blank(),
        strip.background = element_blank())
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/State1v5_Events.pdf'),
       a, width=60, height = 60, units='mm', dpi = 600)
...
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/分支曲线染色体.pdf'),
...
a
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/Seismic_展示chr17.pdf'),
       a, width=100, height = 60, units='mm', dpi = 600)
...
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/Seismic_展示chr17_mean.pdf'),
       a, width=100, height = 60, units='mm', dpi = 600)
...
height_in = 50 / 25.4
dev.off()
pdf('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/state功能热图.pdf', width=width_in, height=height_in)
...
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/monocle_Hallmark.pdf'),
       g, width=120, height = 80, units='mm', dpi = 600)
...
pdf(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/monocle_DF.pdf'),width = 8,height = 8)
...
pdf(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/monocle_DF_mark.pdf'),width = 15,height = 12)
draw(ht, padding = unit(c(20, 10, 10, 10), "mm"))
dev.off()
...
a=gene_cna %>%
  ...
  theme(panel.grid = element_blank(),
        plot.title = element_text(hjust = 0.5, face = 'bold'))
ggsave(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/CAVIN1_CNA比较.pdf'),
       a, width=60, height = 60, units='mm', dpi = 600)
...
pdf(paste0('/Users/lab/wangxin/单细胞进化轨迹推断/手稿文件/第一次/原图BC/hallmark.pdf'),width = 8,height = 8)
draw(ht, padding = unit(c(20, 10, 10, 10), "mm"))
dev.off()
